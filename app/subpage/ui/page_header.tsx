...
function findMainLinkWithName(name: string) {
    return menus.filter(link => link.eng_name == name)[0];
}
export default function PageHeader(){
    ...
    const imageURLPrefix = '/subpage_images/';
