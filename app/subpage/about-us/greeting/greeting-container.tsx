        ...
        <div className={'w-full flex max-w-[1440px]'}>
            <div className={'flex flex-col md:flex-row'}>
                <div className={`md:basis-0 md:grow-[1.5] md:text-lg pt-3 shadow-md px-5 py-6 md:pr-10 bg-white md:z-10`}>
                    <div className={`${styles.slideUp} w-full h-full text-black`}>
                ...
                <div className={'order-first h-[50px] w-full md:order-last md:basis-0 md:grow-[1] hidden md:flex md:h-full'}>
                    <div className={`relative md:w-[200px] h-[80%] self-start`}>
                        <div className={clsx(`${styles.slideInLate} absolute top-3 h-[90%] max-h-[400px] left-0 md:text-6xl text-white w-[85%] flex justify-end pt-3 pr-2 bg-red-700 -z-20`,{
                            'hidden' : !isVisible2
                        })}>
                            K
                        </div>
